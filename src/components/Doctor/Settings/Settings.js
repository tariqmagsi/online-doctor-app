  ...
  render() {
    ...
    return (
      <Container style={{backgroundColor: "#f7f7f7"}}>
        ...
        <Content>
          <ListItem icon button onPress={() => {this.props.navigation.navigate("Profile Information Doctor")}}>
            <Left>
          ...
          <ListItem icon button onPress={() => {this.props.navigation.navigate("Edit Profile Doctor")}}>
            <Left>
          ...
          <ListItem icon button onPress={() => {this.props.navigation.navigate("Change Password Doctor")}}>
            <Left>
